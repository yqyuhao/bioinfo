...
# Annovar 2017-07-17
WORKDIR $software/source
RUN git clone http://github.com/yqyuhao/bioinfo.git && cd bioinfo && unzip annovar_2017-07-17.zip && cd annovar && cp *.pl $software/bin
...
COPY SureSelect_Human_All_Exon_V6_R2_hg19.anti.cnvkit.bed SureSelect_Human_All_Exon_V6_R2_hg19.cnvkit.bed SureSelect_Human_All_Exon_V6_R2_hg19.bed $software/target/
